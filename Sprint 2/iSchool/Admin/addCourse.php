...
if (isset($_REQUEST['courseSubmitBtn'])) {
  ...
  if (
    ...
    // Use only the filename (or relative path) in the database
    $sql = "INSERT INTO course (course_name, course_desc, course_author, course_img, course_duration, course_price, course_original_price) VALUES ('$course_name', '$course_desc', '$course_author', '$course_image', '$course_duration', '$course_price', '$course_original_price')";
